$(function () {
    ...
    $(window).on('load', function () {
        ...
        var location_coord = document.getElementById('location_coord').value;
        location_coord = JSON.parse(location_coord)

        if($("#map").length > 0) {
            var latitude = location_coord[0].latitude
            var longitude = location_coord[0].longitude
